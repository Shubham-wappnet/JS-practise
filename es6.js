...
function sumNum(num1, num2) {
  ...
  // ES5
  var name = "Shubham";
  var greeting = "Hello, " + name + "!"; // Output: Hello, Shubham!
  
  // ES6
  const name = "Shubham";
  const greeting = `Hello, ${name}!`; // Output:  Hello, Shubham!
  
  //     ------ 4. Destructuring Assignment -----
  
  // ES6
  const person = { name: "Shubham", age: 21 };
  ...
  console.log(greet("Shubham")); // Output: Hello, John!
  ...
  var txt = "Shubham Lad";
  txt.endsWith("Lad"); // Returns true
  
  Array.from("ABCDEFG"); // convert string into array
